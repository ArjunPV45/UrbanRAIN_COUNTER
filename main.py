...
from config import SERVER_HOST, SERVER_PORT, DEBUG_MODE, CORS_ALLOWED_ORIGINS, SOCKETIO_ASYNC_MODE
...
def main():
    ...
    try:
        # Create application
        app, socketio, components = create_app()
        ...
        if 'components' in locals() and components['pipeline_manager']:
